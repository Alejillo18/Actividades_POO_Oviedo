...
para que sea una asocian, podriamos editar la clase aeroplano, para que se cree dentro la turbina que utilizaremos, que no hace uso de la misma,
...
obviamente tendriamos que tener la clase Turbina tambien definida:

*
class Turbina {
    constructor(private potencia: number) {}
    toString() { return `Turbina de ${this.potencia} HP`; }
}
...
cuando se crea el aeroplano, con la turbina se crean al mismo tiempo, como cuando se destruye el avion, con las helices, cubierta, tren de aterrizaje, se crean antes, pero si se destruye el avion, los mismos siguen "vivos" en nuestro sistema.
